...
yBeg = 1;
yEnd = size(stars,2);
currPatchChan1 = double(stars[xBeg:xEnd,yBeg:yEnd,1]);
currPatchChan2 = double(stars[xBeg:xEnd,yBeg:yEnd,2]);
currPatchChan3 = double(stars[xBeg:xEnd,yBeg:yEnd,3]);
...
temp1 = reshape(currPatchLightPolMask_col(:,1),size(currPatchChan1,1),size(currPatchChan1,2));
temp2 = reshape(currPatchLightPolMask_col(:,2),size(currPatchChan1,1),size(currPatchChan1,2));
temp3 = reshape(currPatchLightPolMask_col(:,3),size(currPatchChan1,1),size(currPatchChan1,2));
